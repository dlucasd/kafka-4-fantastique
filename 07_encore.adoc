...
[.notes]
--
* linger.ms: batching par défaut plus efficace. le batch.size permet toujours de déclencher l'envoi.
* after.max: éviter rotations anormaux si des timestamps “futurs” sont envoyés par erreur
* KIP-1030
--
...
* recovery.threads: *rétablissement* plus rapide après arrêt non propre, il faut adapter au nombre de coeurs
* d'autres configs à aller voir
* KIP-1030
--
